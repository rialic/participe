          ...
          <v-row>
            ...
            <v-col v-if="showAllInputs || showEmailSexInputs" cols="12" md="4" class="py-1">
              <v-select
                ...
                :error-messages="errorMessage('sex', errors)"
                density="small"
                required variant="outlined"
                color="orange-darken-4"
                placeholder="Sexo"
            ...
            <v-col v-if="showAllInputs || showEstablishmentsInputs" cols="12">
              <v-autocomplete
                ...
                v-model="form.cbo"
                :items="cboStore.list"
                :error-messages="errorMessage('cbo', errors)"
            ...
            <v-col v-if="showAllInputs || showEstablishmentsInputs" cols="12" md="6">
              <v-autocomplete
                ...
                :error-messages="errorMessage('city', errors)"
                density="small"
                no-data-text="Nenhum item encontrado."
                required variant="outlined"
                color="orange-darken-4"
            ...
            <v-col v-if="showAllInputs || showEstablishmentsInputs" cols="12">
              <v-autocomplete
                ...
                :error-messages="errorMessage('establishment', errors)"
                density="small"
                no-data-text="Nenhum item encontrado."
                required variant="outlined"
                color="orange-darken-4"
