...
class PermissionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Permission::firstOrCreate(['name' => 'EVENT.WEBCLASS-SAVE'], ['description' => 'Permite o usuário inserir novas web-aulas na página de criação']);
        Permission::firstOrCreate(['name' => 'EVENT.WEBCLASS-EDIT'], ['description' => 'Permite o usuário acessar à página para editar web-aulas']);
        Permission::firstOrCreate(['name' => 'EVENT.WEBCLASS-UPDATE'], ['description' => 'Permite o usuário alterar web-aulas na página de edição']);
        Permission::firstOrCreate(['name' => 'EVENT.WEBCLASS-DELETE'], ['description' => 'Permite o usuário excluir web-aulas']);
        ...
        Permission::firstOrCreate(['name' => 'EVENT.COURSE-SAVE'], ['description' => 'Permite o usuário inserir novos cursos na página de criação']);
        Permission::firstOrCreate(['name' => 'EVENT.COURSE-EDIT'], ['description' => 'Permite o usuário acessar à página para editar cursos']);
        Permission::firstOrCreate(['name' => 'EVENT.COURSE-UPDATE'], ['description' => 'Permite o usuário alterar cursos na página de edição']);
        Permission::firstOrCreate(['name' => 'EVENT.COURSE-DELETE'], ['description' => 'Permite o usuário excluir cursos']);
        ...
        Permission::firstOrCreate(['name' => 'SETTINGS.USER-SAVE'], ['description' => 'Permite o usuário inserir novos usuários na página de criação']);
        Permission::firstOrCreate(['name' => 'SETTINGS.USER-EDIT'], ['description' => 'Permite o usuário acessar à página para editar usuários']);
        Permission::firstOrCreate(['name' => 'SETTINGS.USER-UPDATE'], ['description' => 'Permite o usuário alterar usuários na página de edição']);
        Permission::firstOrCreate(['name' => 'SETTINGS.USER-DELETE'], ['description' => 'Permite o usuário excluir usuários']);
        ...
        Permission::firstOrCreate(['name' => 'SETTINGS.ROLES-SAVE'], ['description' => 'Permite o usuário inserir novos papéis na página de criação']);
        Permission::firstOrCreate(['name' => 'SETTINGS.ROLES-EDIT'], ['description' => 'Permite o usuário acessar à página para editar papéis']);
        Permission::firstOrCreate(['name' => 'SETTINGS.ROLES-UPDATE'], ['description' => 'Permite o usuário alterar papéis na página de edição']);
        Permission::firstOrCreate(['name' => 'SETTINGS.ROLES-DELETE'], ['description' => 'Permite o usuário excluir papéis']);
    }
}
